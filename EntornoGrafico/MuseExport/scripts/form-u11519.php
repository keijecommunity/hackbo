...
$form = array(
	'subject' => 'Envío de Formulario ValoraciónEX',
	...
	'fields' => array(
		'custom_U11523' => array(
			'order' => 1,
			'type' => 'string',
			'label' => 'Valoración por placa',
			'required' => true,
			'errors' => array(
				'required' => 'El campo \'Valoración por placa\' es obligatorio.'
			)
		),
		'Email' => array(
			'order' => 2,
			'type' => 'email',
			'label' => 'Valoración por Línea',
			'required' => true,
			'errors' => array(
				'required' => 'El campo \'Valoración por Línea\' es obligatorio.',
				'format' => 'El campo \'Valoración por Línea\' contiene un correo electrónico no válido.'
			)
		),
		'custom_U11532' => array(
			'order' => 3,
