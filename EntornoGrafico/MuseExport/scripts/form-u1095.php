...
$form = array(
	'subject' => 'Envío de Formulario Usuario Extranjero',
	...
	'fields' => array(
		...
		'custom_U1097' => array(
			'order' => 3,
			'type' => 'string',
			'label' => 'Ciudad a visitar',
			'required' => true,
			'errors' => array(
				'required' => 'El campo \'Ciudad a visitar\' es obligatorio.'
			)
		),
		'custom_U1112' => array(
			'order' => 4,
			'type' => 'string',
			'label' => 'País a visitar',
			'required' => true,
			'errors' => array(
				'required' => 'El campo \'País a visitar\' es obligatorio.'
			)
		)
	)
);
